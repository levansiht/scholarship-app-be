...
export const CreateScholarshipDtoSchema = z
  .object({
    ...
    startDate: z.coerce
      .date({ message: MSG.START_DATE.INVALID })
      .refine((date) => date > new Date(), {
    ...
    tags: z
      .array(
        z.string().min(1).max(50, 'Each tag must be at most 50 characters'),
      )
      .max(10, 'Maximum 10 tags allowed')
      .default([]),
    thumbnailUrl: z
      .string()
      .url(MSG.THUMBNAIL_URL.INVALID)
      .optional()
      .nullable(),
  })
  .refine(
